...
const pricingPlans = [
  { name: "Basic", price: 9.99, features: ["10GB SSD Storage", "1 Website", "Free SSL Certificate", "Daily Backups", "Basic CDN", "Premium Themes", "Priority Support", "Dedicated IP", "Performance Optimization"] },
  { name: "Premium", price: 19.99, features: ["30GB SSD Storage", "3 Website", "Free SSL Certificate", "Daily Backups", "Premium CDN", "Premium Themes", "Priority Support", "Dedicated IP", "Performance Optimization"] },
  { name: "Business", price: 29.99, features: ["100GB SSD Storage", "Unlimited Websites", "Free SSL Certificate", "Daily Backups", "Premium CDN", "Premium Themes", "Priority Support", "Dedicated IP", "Performance Optimization"] }
];
