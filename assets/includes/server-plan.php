...
<body>
    ...
    <div class="main-container d-flex flex-column flex-lg-row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="filter-group mb-4">
                        <label>RAM (GB)</label>
                        <div class="range-slider">
                            <input type="range" id="ramSliderModal" min="16" max="512" step="16" value="16"
                                class="slider">
        ...
        <div class="row pricings-row" id="pricingsmain-container">
            <div class="pricings-card-wrapper" data-cores="4" data-threads="8" data-ram="16" data-price="74.80"
                data-storage="ssd" data-location="us">
            ...
            <div class="pricings-card-wrapper" data-cores="8" data-threads="16" data-ram="64" data-price="115.80"
                data-storage="ssd" data-location="us">
                <div class="pricings-card">
                    <div class="pricings-header">
            ...
            <div class="pricings-card-wrapper" data-cores="16" data-threads="32" data-ram="128" data-price="174.25"
                data-storage="nvme" data-location="us">
            ...
            <div class="pricings-card-wrapper" data-cores="24" data-threads="48" data-ram="256" data-price="257.80"
                data-storage="nvme" data-location="us">
                <div class="pricings-card">
                    <div class="pricings-header">
            ...
            <!-- Additional Servers -->
            <div class="pricings-card-wrapper" data-cores="8" data-threads="16" data-ram="32" data-price="98.50"
                data-storage="ssd" data-location="eu">
                <div class="pricings-card">
                    <div class="pricings-header">
            ...
            <div class="pricings-card-wrapper" data-cores="16" data-threads="32" data-ram="64" data-price="145.30"
                data-storage="nvme" data-location="eu">
                <div class="pricings-card">
                    <div class="pricings-header">
            ...
            <div class="pricings-card-wrapper" data-cores="4" data-threads="8" data-ram="16" data-price="82.40"
                data-storage="ssd" data-location="asia">
                <div class="pricings-card">
                    <div class="pricings-header">
            ...
            <div class="pricings-card-wrapper" data-cores="32" data-threads="64" data-ram="256" data-price="295.70"
                data-storage="nvme" data-location="asia">
                <div class="pricings-card">
                    <div class="pricings-header">
    ...
    const pricingPlans = [{
            name: "Starter",
            price: 74.80,
            features: ["4 Cores / 8 Threads", "16 GB RAM DDR5", "1x 480 GB SSD", "F1 IPv4 Address",
                "1 Gbps Network"]
        },
        {
            name: "Professional",
            price: 115.80,
            features: ["8 Cores / 16 Threads", "64 GB RAM DDR5", "2x 960 GB SSD", "F1 IPv4 Address",
                "1 Gbps Network"
            ]
        },
        {
            name: "Enterprise",
            price: 174.25,
            features: ["16 Cores / 32 Threads", "128 GB RAM DDR5", "2x 960GB NVMe", "1 IPv4 Address",
                "10 Gbps Network"
            ]
        },
        {
            name: "Ultra",
            price: 257.80,
            features: ["24 Cores / 48 Threads", "256 GB RAM DDR5", "2x 960 GB NVMe SSD", "1 IPv4 Address",
                "10 Gbps Network"
            ]
        },
        {
            name: "Euro Standard",
            price: 98.50,
            features: ["8 Cores / 16 Threads", "32 GB RAM DDR5", "1x 960 GB SSD", "1 IPv4 Address",
                "1 Gbps Network"]
        },
        {
            name: "Euro Pro",
            price: 145.30,
            features: ["16 Cores / 32 Threads", "64 GB RAM DDR5", "2x 480 GB NVMe", "1 IPv4 Address",
                "10 Gbps Network"
            ]
        },
        {
            name: "Asia Starter",
            price: 82.40,
            features: ["4 Cores / 8 Threads", "16 GB RAM DDR5", "1x 480 GB SSD", "1 IPv4 Address", "1 Gbps Network"]
        },
        {
            name: "Asia Enterprise",
            price: 295.70,
            features: ["32 Cores / 64 Threads", "256 GB RAM DDR5", "2x 1.9 TB NVMe SSD", "1 IPv4 Address",
                "10 Gbps Network"
            ]
        }
    ];
    ...
    function syncFilters() {
        ...
        const pairs = [{
                desktop: 'coresSlider',
                modal: 'coresSliderModal'
            },
            {
                desktop: 'threadsSlider',
                modal: 'threadsSliderModal'
            },
            {
                desktop: 'ramSlider',
                modal: 'ramSliderModal'
            },
            {
                desktop: 'priceSlider',
                modal: 'priceSliderModal'
            },
            {
                desktop: 'ssdFilter',
                modal: 'ssdFilterModal'
            },
            {
                desktop: 'nvmeFilter',
                modal: 'nvmeFilterModal'
            },
            {
                desktop: 'locationFilter',
    ...
    function applyFilters() {
        ...
        cards.forEach(card => {
            ...
            if (matchesCores && matchesThreads && matchesRam && matchesPrice && matchesStorage &&
                matchesLocation) {
